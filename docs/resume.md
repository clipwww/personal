...
擁有 9 年以上網站與 Web 應用程式開發經驗的前端工程師，專精於 Vue.js 及其生態系，並具備基礎後端開發能力。熟悉從零到一建置後台管理系統、會員平台等面向終端使用者的服務型網站，開發過程高度重視使用者體驗與整體品質。

積極主動負責，樂於為共同目標與團隊協作，能在團隊協作中發揮正面影響力，同時具備獨立解決問題、有效完成分配任務與持續學習精進的能力。

| 📍 地點 | 📞 電話 | ✉️ Email |
|---|---|---|
|  新北市, 台灣 |  0925151578 | clipwww@gmail.com |
...
| 類別 | 技術 |
|------|------|
| 核心技術 | HTML / CSS / JavaScript / TypeScript |
| 框架 | Vue.js / Nuxt.js |
| 狀態管理 | Vuex / Pinia |
| 路由 | Vue-Router |
| UI 框架 | ElementUI / Vuetify / VantUI / NuxtUI |
| 樣式 | TailwindCSS / WindiCSS / SASS / SCSS |
| 建構工具 | Vite / VueCli / Parcel.js |
| 國際化 | Vue-i18n |
| 工具函式庫 | VueUse |
| HTTP 客戶端 | GraphQL / Apollo Client / Axios / Fetch |
| 資料驗證 | Zod / Yup |
| 資料視覺化 | Chart.js / D3.js |
| 測試 | Vitest / Jest |
| 程式碼品質 | ESLint |
| 其他 | LINE Front-end Framework (LIFF) / jQuery |
...
| ORM | DrizzleORM |
| HTTP 客戶端 | Got / Axios / Fetch |
| 日誌 | Pino |
| 金流 | TapPay / Stripe / 藍新金流 |
...
- 導入 TypeScript 增強程式碼可讀性與可維護性、提升開發效率與體驗，並能有效減少執行時錯誤
- 協助客服釐清客戶問題

::: tip 技術棧
`Vue.js` `Pinia` `JIRA` `Figma` `TypeScript` `TailwindCSS` `Lokalise`
:::
...
::: tip 技術棧
`Vue.js` `Nuxt.js` `Vuex` `Express.js` `TypeScript` `SASS` `GraphQL`
:::
...
- **東海大學 - 資訊管理學系暨研究所** • 2013/09 - 2015/06

- **東海大學 - 資訊工程學系** • 2009/09 - 2013/06
...
| 2016/09/03 | [Vuediner #4 一頭栽入 Vue.js TDD 的世界 (威力加強版)](https://vuejs.kktix.cc/events/vuedinner4) |
...
| 2019/09/04 | [程式勇者與他們的武器：集結 Markdown、VSCode、GitHub 開發者三項之力的首次小聚](https://hackmd.kktix.cc/events/markdown-vscode-github-developer-meetup) |
| 2019/10/21 | [vue taiwan meetup #005 X LINE Fukuoka](https://vuejs.kktix.cc/events/v-tw-meetup-005) |
| 2019/12/01 | [GDG DevFest Taipei 2019](https://gdg-taipei.kktix.cc/events/devfest-2019) |
| 2019/12/04 | LINE Developer Meetup 開發者小聚系列活動 #10 |
| 2020/08/19 | [v-tw meetup #006 @LINE TW](https://vuejs.kktix.cc/events/v-tw-meetup-006) |
| 2021/06/24 | [v-tw meetup #007 @online](https://vuejs.kktix.cc/events/v-tw-meetup-007) |
